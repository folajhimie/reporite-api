const resetPassword = function (resetUrl: string, firstname: string, lastname: string) {
    const html = `
    <!DOCTYPE html>
    <html lang="en">
                                                ...
                                                ">
                                                    ...
                                                    ">
                                                        ...
                                                        ">
                                                                                    ...
                                                                                    <p
                                                                                        style="font-size: 16px; font-weight: 500; line-height: 1.5;">
                                                                                        If clicking the button doesn't work, copy and paste the link below in your browser: ${resetUrl}
                                                                                    </p>
