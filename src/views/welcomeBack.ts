const welcomeBack = function (
                                                    ...
                                                    ">
                                                        ...
                                                        ">
                                                            ...
                                                            ">
                                                                                        ...
                                                                                        <p
                                                                                            style="font-size: 16px; font-weight: 500; line-height: 1.5;">
                                                                                            Please be informed that your CartTel profile was accessed on <b>${getUserDate} ${getUserTime}.</b></p>
                                                                                        <p
                                                                                            style="font-size: 16px; font-weight: 500; line-height: 1.5;">
                                                                                            Please if you did not initiate this action, contact our customer support on <a href="mailto:folajimishodipo1@gmail.com">folajimishodipo1@gmail.com</a>
                                                                                            or 01 888 9990 as your account might have been compromised.</p>
                                                                                        <p
    ...
    const text = `
        Account was successfully Login, You can now access your Dashboard.
    `;
