const resendOTPUser = function (decryptedLoginCode: string, name: string) {
    const html = `
      <!DOCTYPE html>
                ...
                <table class="sm-w-full" style="font-family: 'Montserrat',Arial,sans-serif; width: 600px;" width="600"
                  ...
                  <tr>
                    <td class="sm-py-32 sm-px-24"
                      ...
                      align="center">
                      Dear <label style="display: block; font-size: 24px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #000000; text-decoration: none;">${name}</label>,
                    </td>
                  </tr>
                  <tr>
                    <td class="sm-py-32 sm-px-24"
  ...
  Use this link to confirm your account and log in
                            ...
                            <label style="display: block; font-size: 24px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #000000; text-decoration: none;">${decryptedLoginCode}</label>
